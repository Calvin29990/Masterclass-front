...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_header_footer(self, page_count):
        ...
        self.setFont("Helvetica", 8)
        self.setFillColor(colors.HexColor("#64748b"))
        self.drawString(40, 32, "Opérations : Calvin (Front Office Janv 2027) | Yasmine (Alternance M2)")
...
story.append(Paragraph("<b>Candidat</b> : Calvin Minang — SKEMA Business School (PGE & Double Diplôme MSc Corporate Financial Management / CFM)<br/><b>Opérations actives</b> : Calvin FO Janvier 2027 | Yasmine Touil (Alternance M2)", subtitle_style))
...
# NOTE 14/09/2026 : la section 5 « Dossier Vianney-Aldrin Minang — CDI Junior Génie Industriel »
# a été retirée — le réseau d'Aldrin est hors périmètre de cette stratégie (règle de non-mélange).
