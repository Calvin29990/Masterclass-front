...
- [`POSITIONNEMENT-ce-quon-raconte.md`](POSITIONNEMENT-ce-quon-raconte.md) — **a lire avant tout entretien** : pourquoi l'origine gabonaise reste hors du recit (risque d'assignation au desk Afrique), le recit a utiliser (BPCE, infrastructure, execution, eFX), l'interdiction definitive de l'echange au Bresil invente, et quoi repondre si on pose la question directement.
- [`REGIMES-de-change-peg-vs-flottant.md`](REGIMES-de-change-peg-vs-flottant.md) — munition technique, a citer a la troisieme personne : parite fixe a 655,957, recettes en dollars, impossibilite de devaluer, reserves CEMAC et couverture des importations. Sert a repondre sur les regimes de change, jamais a parler de soi.
