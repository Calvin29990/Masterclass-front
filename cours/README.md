...
- [`BIBLIOTHEQUE-scholarvox-plan-de-lecture.md`](BIBLIOTHEQUE-scholarvox-plan-de-lecture.md) — **le Top 5, la colonne vertebrale d'un junior FX / LatAm**. Les deux catalogues ScholarVox de SKEMA (Management en francais, International en anglais), cinq livres justifies un par un avec leurs docids : Klein & Lamarque pour le metier de sales change, Donnelly pour le marche et le vocabulaire de risque, le Guide pratique du change pour le point de vue du tresorier, Thery pour le Bresil, Dabene pour l'Amerique latine. Plus pourquoi l'espagnol passe par Banxico et non par un manuel, trois pieges du catalogue, le statut de verification de chaque titre, un calendrier en trois phases et la methode de notes en trois colonnes.
