...
- [`MASTERCLASS-FINALE-notions-cles.md`](MASTERCLASS-FINALE-notions-cles.md) - **le dernier cours ecrit, avant de passer a l'oral avec Gemini**. Les cinq reflexes de reponse, le change (cotation, terme, NDF, swap), les options (Garman-Kohlhagen, parite call-put verifiee, les cinq grecs, smile et skew), les quatre structures corporate et l'option asiatique a moins 42 pourcent de volatilite, le minimum taux (duration, convexite, DV01, courbe inversee), le metier et son lexique, **les quinze questions classiques avec la reponse en moins de 20 secondes**, les trois questions a poser, le prompt Gemini et le tableau des chiffres a avoir en tete.
- [`FICHE-evenement-DB-questions-et-noms.md`](FICHE-evenement-DB-questions-et-noms.md) - **la fiche telephone pour l'evenement Deutsche Bank**. L'amorce en 8 secondes, les deux questions precises (le moteur de pricing emergents deplace a Singapour en 2021, et l'effet d'une semaine BCE-Fed sur les volumes clients du desk parisien) en francais et en anglais, les cinq regles du jour, le vocabulaire FR/EN avec les pieges de prononciation, un tableau vide pour noter les noms pendant l'evenement, le message de suivi a envoyer sous 24 h, et un prompt pret a coller pour s'entrainer avec Gemini.
- [`TAUX-Pichet-et-produits-desk-LatAm.md`](TAUX-Pichet-et-produits-desk-LatAm.md) - **une heure de taux, en complement du Pichet**. Comment lire le Guide pratique des obligations avec les trois filtres (convention, porteur du risque, couverture), pourquoi le DV01 est la seule mesure qui s'additionne, et pourquoi egaliser deux DV01 sur deux courbes differentes cree un spread trade au lieu d'un hedge. Puis tout ce que Pichet n'a pas : les cinq titres bresiliens, la LFT qui casse la transmission monetaire, le DI1 cote en taux mais regle en PU, et les cinq produits du desk LatAm (NDF, cupom cambial, les quatre structures corporate, Garman-Kohlhagen). Cinq exercices corriges.
- [`RESSOURCES-taux-bresil-gratuites.md`](RESSOURCES-taux-bresil-gratuites.md) - **les sources gratuites et legales pour combler le trou taux**, parce que les questions 101-125 sont du fixed income deguise en FX. Le cours gratuit du Tesouro Nacional avec certificat et ses cinq chapitres avances, les cinq titres publics (LTN, NTN-F, LFT, NTN-B) et pourquoi la LFT casse la transmission monetaire, la trilogie Selic meta / Selic over / CDI, les specifications du contrat DI1 en base 252 jours ouvres, le RPM trimestriel et le QPC, le Focus hebdomadaire, le SGS et son API, les sources Banxico BanRep BCCh en espagnol, et l'histoire bancaire bresilienne de 1808 a la loi d'autonomie de 2021.
- [`150-QUESTIONS-FX-LATAM-front-office.md`](150-QUESTIONS-FX-LATAM-front-office.md) - **le banc d'essai, 150 questions et reponses courtes, en francais**. Structure et vocabulaire du marche, change a terme et parites, options et structures (tunnel, terme booste, accumulateur, restructuration), carry trade chiffre, l'Amerique latine region par region, le Bresil en profondeur (Selic, Copom, PTAX, B3, DOL, cupom cambial, dette et courbe), le comportement de desk, et une derniere section taux / credit / exotiques si un autre desk rappelle. Trois passages d'entrainement et les vingt questions a savoir sans reflechir.
- [`BILAN-lectures-et-ce-qui-reste.md`](BILAN-lectures-et-ce-qui-reste.md) - **le debriefing apres 700 pages lues sur ScholarVox**, remplace le plan de lecture. Ce qui est acquis (socle triangule sur trois livres), l'alerte sur le vocabulaire retail herite du Guide complet du Forex avec le tableau des mots interdits en entretien, les quatre structures a connaitre (terme sec, tunnel, terme booste, accumulateur) et le mot restructuration, ce qui reste (Dupuy par chapitres, BNDES et Dabene en phase 2), et la bascule de la lecture vers l'oralite avec cinq questions chronometrees.
